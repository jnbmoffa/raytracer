...
protected:
											...
											ApertureDistribution(-1.f, 1.f)
	{
		...
		m_luaCamera.up = -m_luaCamera.up; m_luaCamera.up.normalize();
		m_luaCamera.right = cross(m_luaCamera.up,m_luaCamera.view); m_luaCamera.right.normalize();
		...
		m_planeParams.halfWidth = m_luaCamera.FocalDistance*tan(radFOV/2);
